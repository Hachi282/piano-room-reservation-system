...
<body>
    ...
    <div class="card">
        <div class="table-responsive">
            <h4 class="text-center" style="color:#787878">所有預約資料</h4>
            <table class="table table-striped-columns align-items-center mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ">姓名</th>
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ">電話</th>
  ...
  <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        "<tr>
                            ...
                            <td class='align-middle text-left'>
                                <div class='d-flex align-items-left'>
                                    <span class='me-2 text-xs'>" . $row['name'] . "</span>
                                </div>
                            </td>
                            <td class='align-middle text-left'>
                                <div class='d-flex align-items-left'>
                                    <span class='me-2 text-xs'>" . $row['phone'] . "</span>
                                </div>
                            </td>
                            <td class='align-middle text-left'>
                                <div class='d-flex align-items-left'>
                                    <span class='me-2 text-xs'>" . $row['email'] . "</span>
                                </div>
                            </td>
                            <td class='align-middle text-center'>
                                <div class='d-flex align-items-center'>
                                    <span class='me-2 text-sm' ><a href='calloff_form.php?ID=" . $row['ID'] . "&action=update' style='color:orange'>修改</a></span>
                                    <span class='me-2 text-sm' ><a href='calloff_d2.php?ID=" . $row['ID'] . "&action=delete' style='color:red'>刪除</a></span>
                                </div>
                            </td>
                        </tr>";
                    }
